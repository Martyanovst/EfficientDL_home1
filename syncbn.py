...
class sync_batch_norm(Function):
    ...
    def forward(ctx, input, running_mean, running_std, eps: float, momentum: float):
        ...
        ctx.save_for_backward(output, n, output_std, eps)
...
class SyncBatchNorm(_BatchNorm):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        output, self.running_mean, self.running_std = sync_batch_norm.forward(input, self.running_mean, self.running_std)
        return output
